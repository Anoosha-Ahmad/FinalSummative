 ...
 * @author ahmaa1808
 */
public class Final extends JComponent {
    ...
    //create a new colour for the background of the game
    Color darkblue = new Color(0, 54, 204);
    ...
    public void paintComponent(Graphics g) {
        ...
        //set the background of the game to be blue
        g.setColor(darkblue);
        g.fillRect(0, 0, 1275 , 1000);
        
        //create a division for player 1 and player 2 
        g.setColor(Color.BLACK);
        g.drawLine(637, 1000 , 637, 0) ;
    ...
    public static void main(String[] args) {
        ...
        // creaating the battleship game board and its pieces 
